...
The public API lives at the module root (`github.com/go-ruby-graphql/graphql`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `graphql`, while the surface follows
...
```go
import "github.com/go-ruby-graphql/graphql"
```
...
- **[pkg.go.dev/github.com/go-ruby-graphql/graphql](https://pkg.go.dev/github.com/go-ruby-graphql/graphql)**

The module's [README](https://github.com/go-ruby-graphql/graphql#readme) carries worked
